...
public class DBQueries {
    public static final String GET_STYLES = "select s.id, style_name, count(b.id) as beer_count from styles s, beers b where b.style_id = s.id group by s.id order by beer_count DESC, style_name;";
